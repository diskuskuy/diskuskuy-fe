...
export default function DiscussionGuide() {
  ...
  const [
    ...
    setShowDiscussionGuideUpdateConfirmation,
  ] = useState(false);
    ...
    <>
      <main className={styles.main}>
        ...
        <div className="section">
          <a
            onClick={() => router.back()}
            className="text-xs text-purple cursor-pointer"
          >
          ...
          <div className="flex flex-row gap-5">
            <div className="flex flex-col basis-2/3 gap-5">
              ...
              {discussionGuideConstants.map((object, i) => (
                <div
                  ...
                  style={{
                    borderBottom:
                      i == currentPhase ? "5px solid #2ECC71" : null,
                  }}
                >
            ...
            <div className="basis-1/3">
              <div className="border-dashed border-2 border-grey rounded-lg flex flex-col p-5">
                <p>
                  <strong>Deadline:</strong> 21 November 2020 | 23:55
                </p>
                <strong>Deskripsi:</strong>
                <p>
                  Pada aktivitas forum diskusi kali ini, kita akan mendiskusikan
                  good design vs bad design.
                </p>
                <strong>Mekanisme dan Ekspektasi:</strong>
                <p>
                  Kelompok diharapkan berhasil menjawab pertanyaan yang muncul
                  melalui proses inquiry dan menyusun serta melaporkan hasil
                  diskusi kelompok sebelum deadline di forum.
                </p>
              </div>
            </div>
          </div>
